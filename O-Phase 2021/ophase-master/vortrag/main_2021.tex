...
\begin{frame}
	\frametitle{Fragen -- An wen kann ich mich wenden?}
	Ihr findet alle Gremien und ihre Mitglieder online unter 
	\begin{center}
...
\begin{frame}
	...
	\begin{itemize}
		\item Ihr solltet eine Nutzungsvereinbarung unterschreiben, dann ist euer Nutzerkürzel freigeschaltet.
		...
		\item Einführung in die Dienste: Mittwoch 14:30 - 17 Uhr
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Euer Studierendenausweis ist Eure Mensakarte. Ihr könnt an diversen Automaten in der Mensa und anderswo Geld aufladen. Man kann auch in Bar bezahlen, aber Ihr müsst Euch als Studierender ausweisen, sonst zahlt Ihr mehr.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{\vphantom{X}\smash{Mentoring}}
		Wir bieten dieses Jahr zum vierten Mal ein Programm an, bei welchem erfahrene Studierende als Mentoren von ein bis drei Erstis fungieren. Das Programm wird von der Fakultät und TU4U unterstützt. Das Programm
	\end{block}
